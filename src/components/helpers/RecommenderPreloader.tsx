// TODO: Remove eslint-disable when used or fine a better solution
			...
			<div className="mb-8">
				<div className="flex flex-row flex-wrap -m-2">
					{preloaderCounter.map((preloader) => (
						<div key={preloaderCounter[0]} className="flex-initial w-4/12 p-3">
							<Card as="div" rounded={true} size="S">
								<div className="animate-pulse flex flex-col gap-2 p-1">
									<div className="flex-col inline-flex self-center">
										...
										<div className="mt-4 h-4 w-24 bg-gray-400 rounded-full max-w-[100px]" />
										<div className="mt-4 h-3 w-24 bg-gray-400 rounded-full max-w-[100px]" />
