...
const contentCardvariantMap: Record<
  TContentCard["variant"],
  TContentCardvariantMap
> = {
  detailpage: {
    headlineSize: "XL",
    textSize: "L",
...
export const ContentCard: FC<TContentCard> = ({ variant, post }) => {
  const setting =
    contentCardvariantMap[variant] || contentCardvariantMap.detailpage;
  ...
  const headerSlotContent = (
    <Grid variant="col" gap="S">
      ...
      <Grid variant="row" gap="S">
        <UserName href={`/user/${post.creator.userName}`}>
          ...
          <Image
            ...
            height={
              (ProjectSettings.images.post.width /
                ProjectSettings.images.post.aspectRatio[0]) *
